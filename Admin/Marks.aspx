<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMst.Master" AutoEventWireup="true" CodeBehind="Marks.aspx.cs" Inherits="StudentManagementSystem.Admin.Marks" %>
            ...
            <div class="row mb-3 mr-lg-5 ml-lg-5">
                <div class="col-md-12">
                    ...
                    <asp:GridView ID="GridView1" runat="server" CssClass="table table-hover table-bordered" EmptyDataText="No record to Display" OnRowUpdating="GridView1_RowUpdating"
                        ...
                        OnRowEditing="GridView1_RowEditing" AllowPaging="True" PageSize="4" DataKeyNames="ExamId" OnRowDataBound="GridView1_RowDataBound">
                        <Columns>
