<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMst.Master" AutoEventWireup="true" CodeBehind="TeacherSubject.aspx.cs" Inherits="StudentManagementSystem.Admin.TeacherSubject" %>
            ...
            <div class="row mb-3 mr-lg-5 ml-lg-5">
                <div class="col-md-8">
                    ...
                    <asp:GridView ID="GridView1" runat="server" CssClass="table table-hover table-bordered" EmptyDataText="No record to Display" OnRowUpdating="GridView1_RowUpdating"
                        ...
                        OnRowEditing="GridView1_RowEditing" AllowPaging="True" PageSize="4" DataKeyNames="Id" OnRowDeleting="GridView1_RowDeleting" OnRowDataBound="GridView1_RowDataBound">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Teacher">
                                <EditItemTemplate>
                                    <asp:DropDownList ID="ddlTeacherGv" runat="server" DataSourceID="SqlDataSource3" DataTextField="Name" DataValueField="TeacherId" SelectedValue='<%# Eval("TeacherId") %>' CssClass="form-control">
                                    </asp:DropDownList>
                                    <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:School %>" SelectCommand="SELECT [TeacherId], [Name] FROM [Teacher]"></asp:SqlDataSource>
